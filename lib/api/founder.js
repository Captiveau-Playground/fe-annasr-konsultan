 ...
 */
export function getFounderQueryString(populate = "*") {
 ...
 */
export function normalizeFounderData(rawItem) {
    if (!rawItem)
        return {};
    ...
    const photoAlt = (photoMedia === null || photoMedia === void 0 ? void 0 : photoMedia.alternativeText) ||
        (photoMedia === null || photoMedia === void 0 ? void 0 : photoMedia.caption) ||
        attrs.name ||
        "Founder Photo";
    return {
        name: attrs.name,
 ...
 */
export async function fetchFounderSectionData() {
