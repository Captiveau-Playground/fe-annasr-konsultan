...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
      ...
      <button
        onClick={handleOpen}
        className="w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 group relative border border-blue-500/20"
        aria-label="Hubungi kami di WhatsApp"
      >
        {/* Pulsing visual glow to invite clicks */}
        <span className="absolute -inset-1 rounded-full bg-blue-600/30 animate-ping group-hover:animate-none opacity-75"></span>
